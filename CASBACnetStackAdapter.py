...
fpCallbackDeviceCommunicationControl = ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.c_uint32, ctypes.c_uint8,
...
bacnet_errorCode = {"missing-required-parameter": 16, "password-failure": 26,
